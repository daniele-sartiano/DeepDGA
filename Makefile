...
ed$(EMBEDDING_DIM)b$(BATCH_SIZE)lstm$(LSTM_LAYER_SIZE)dout$(DROPOUT)ep$(EPOCHS)$(BIDIRECTIONAL)$(NODENSE)$(SPLIT).model: $(TRAIN_TASK_1)
...
botnet_ed$(EMBEDDING_DIM)b$(BATCH_SIZE)lstm$(LSTM_LAYER_SIZE)dout$(DROPOUT)ep$(EPOCHS)$(BIDIRECTIONAL)$(NODENSE)$(SPLIT).model: $(TRAIN_TASK_2)
